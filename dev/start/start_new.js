...
//
for (var i = 0; i < rs.subjects.length; i++) {
    console.log("rs.subject[" + i + "]: " + rs.subjects[i] + "\n");
}
for (var i = 0; i < group1.length; i++) {
    console.log("group1[" + i + "]: " + group1[i] + "\n");
}
...
//
    ...
    // ADJUSTED ALLOCATION NOT RETURNING CORRECT VALUE
                    if (rs.self.get("rp.assignedGroup") == 1) {
    console.log("I'm in 1 and in group: " + rs.self.get("rp.assignedGroup"));
    ...
    console.log("I'm in 2 and in group: " + rs.self.get("rp.assignedGroup"));
                        var actualAllocation = tatonnement.adjustedAllocation(
                            $scope.selection,
                            $scope.endowment,
                            roundContext2,
    ...
    console.log("actualAllocation.x: " + actualAllocation.x + "\n");
    console.log("actualAllocation.y: " + actualAllocation.y + "\n");
